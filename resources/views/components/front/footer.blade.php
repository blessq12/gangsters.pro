<footer class="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-16 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
            ...
            <div class="space-y-6">
                <h5
                    class="text-xl font-bold tracking-tight relative inline-block after:content-[''] after:absolute after:w-1/2 after:h-1 after:-bottom-2 after:left-0 after:bg-blue-500/80">
                    Ссылки</h5>
                <ul class="space-y-2">
                    @if (Route::currentRouteName() !== 'main.index')
                        <a href="{{ route('main.index') }}" class="block">
                            <li
                                class="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors duration-300 py-2 hover:translate-x-2 transform">
                    ...
                    <a href="{{ route('main.vacancy') }}" class="block">
                        <li
                            class="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors duration-300 py-2 hover:translate-x-2 transform">
                    ...
                    <ul class="space-y-4">
                        @if ($company->vk)
                            <a href="{{ $company->vk }}" target="_blank" class="block group">
                                <li
                                    class="flex items-center space-x-3 p-3 rounded-lg transition duration-300 hover:bg-white/5 backdrop-blur-sm">
                                    <div
                                    ...
                                    <span class="text-gray-300 group-hover:text-white">Группа Вконтакте</span>
                                </li>
                            </a>
                        @endif
                        @if ($company->inst)
                            <a href="{{ $company->inst }}" target="_blank" class="block group">
                                <li
                                    ...
                                    <span class="text-gray-300 group-hover:text-white">Профиль Instagram</span>
                                </li>
                            </a>
                        @endif
                    </ul>
        ...
        <div class="border-t border-white/10 pt-12 pb-8">
            <div class="flex flex-wrap justify-center md:justify-between items-center gap-8">
                <a href="tel:{{ $company->phone }}"
                    class="flex items-center space-x-3 text-gray-400 hover:text-white transition-colors duration-300">
