    ...
    <div class="container py-5">
        <div class="row row-cols-1 row-cols-lg-2">
            <div class="col mb-4 mb-lg-0">
                ...
                <p>Доставка осуществляется в пределах города и ближайших пригородов. Стоимость доставки зависит от расстояния.</p>
                <p>Мы стараемся доставить ваш заказ максимально быстро, среднее время доставки составляет от 90 до 120 минут, в зависимости от загруженности дорог и удаленности района.</p>
                </p>
            </div>
            <div class="col">
