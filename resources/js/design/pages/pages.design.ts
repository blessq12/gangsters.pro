...
const searchInputClasses =
    "w-full rounded-none border border-black/12 bg-app-surface py-2.5 pl-10 pr-10 text-sm text-app-surface-fg placeholder:text-neutral-600 focus:border-app-accent focus:outline-none focus:ring-1 focus:ring-app-accent/50";
...
export const pagesDesign = {
    home: {
        desktop: {
            ...
            menuTitle: "text-xl font-semibold leading-tight text-app-canvas-fg",
        ...
        mobile: {
            ...
            menuTitle: "text-xl font-semibold text-app-canvas-fg",
            menuSubtitle: "text-sm text-app-muted",
            srOnlyLabel: "sr-only",
    ...
    resetPassword: {
        ...
        title: "mb-1 text-lg font-semibold text-app-canvas-fg",
    ...
    about: {
        ...
        spotlightArticle:
            "overflow-hidden rounded-none border border-black/12 bg-[rgba(0,0,0,0.05)] p-5 shadow-[0_16px_50px_rgba(0,0,0,0.35)]",
        ...
        moodTitle:
            "mt-4 text-2xl font-semibold leading-tight text-app-canvas-fg",
        moodBody: "mt-3 text-sm leading-relaxed text-app-muted",
        stepsGridInner: "grid gap-3 sm:grid-cols-2",
        stepMiniCard:
            "rounded-none border border-black/12 bg-app-surface p-4",
        stepMiniKicker:
            "text-[11px] uppercase tracking-[0.22em] text-app-muted",
        stepMiniTitle: "mt-2 font-medium text-app-canvas-fg",
    ...
    delivery: {
        ...
        highlightCard:
            "rounded-none border border-black/12 bg-[rgba(0,0,0,0.05)] p-5",
        highlightKicker:
            "text-[11px] uppercase tracking-[0.22em] text-app-muted",
        highlightValue: "mt-3 text-3xl font-semibold text-app-accent",
        ...
        stepTitle: "font-medium text-app-canvas-fg",
        stepBody: "mt-2 text-sm text-app-muted",
        gridBottom:
            "grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]",
        paymentRow:
            "flex items-start gap-4 rounded-none border border-black/12 bg-app-surface p-4",
        paymentTitle: "font-medium text-app-canvas-fg",
    ...
    contacts: {
        ...
        channelArticle:
            "rounded-none border border-black/12 bg-[rgba(0,0,0,0.05)] p-5 shadow-[0_16px_50px_rgba(0,0,0,0.35)]",
        channelIconWrap:
            "mb-4 flex h-11 w-11 items-center justify-center rounded-none bg-app-accent text-black",
        channelLabel:
            "text-xs uppercase tracking-[0.22em] text-app-muted",
        channelLoading: "mt-2 text-sm text-app-muted",
        channelValueRow: "mt-2 text-lg font-semibold text-app-canvas-fg",
        ...
        coverageBox:
            "mt-4 rounded-none border border-black/12 bg-app-surface p-4",
        coverageKicker:
            "text-[11px] uppercase tracking-[0.22em] text-app-muted",
        coverageBody: "mt-2 text-sm text-app-canvas-fg",
        siteLinkPara: "mt-4 text-sm",
        scheduleArticle:
            "overflow-hidden rounded-none border border-app-accent/20 bg-[linear-gradient(180deg,rgba(198,36,36,0.1),rgba(0,0,0,0.04))] p-6",
        scheduleEyebrow: "text-xs uppercase tracking-[0.26em] text-app-accent",
        scheduleTime: "mt-4 text-3xl font-semibold text-app-canvas-fg",
        scheduleNote: "mt-3 text-sm leading-relaxed text-app-muted",
        feeStack: "mt-5 space-y-2 text-sm text-app-canvas-fg",
        feeRow:
            "flex items-center justify-between rounded-none border border-black/12 bg-app-surface px-4 py-3",
        ...
        tipKicker:
            "text-[11px] uppercase tracking-[0.22em] text-app-muted",
        tipTitle: "mt-2 font-medium text-app-canvas-fg",
