...
export const modalDesign = {
    ...
    content: "pointer-events-none relative z-[1] w-full",
    sizes: {
        md: {
            innerWrap: "relative z-10 mx-auto w-full max-w-lg px-4 sm:px-6 lg:px-8",
            card:
                "pointer-events-auto rounded-none border border-app-border-on-surface bg-app-canvas px-4 sm:px-6 lg:px-8 py-5 shadow-2xl shadow-black/70 backdrop-blur-xl",
        ...
        lg: {
            ...
            card:
                "pointer-events-auto flex max-h-[min(90vh,52rem)] flex-col rounded-none border border-app-border-on-surface bg-app-canvas px-4 sm:px-6 lg:px-8 py-5 shadow-2xl shadow-black/70 backdrop-blur-xl",
