            ...
            <transition enter-active-class="animate__animated animate__fadeIn" leave-active-class="animate__animated animate__fadeOut" mode="out-in">
              ...
              <div v-else>
                ...
                <div style="position: relative; overflow: hidden" id="map-collapse" class="collapse overflow-hidden mt-4 rounded">
                  <a href="https://yandex.ru/maps/org/gangster_s_sushi/82888444717/?utm_medium=mapframe&utm_source=maps" style="color: #eee; font-size: 12px; position: absolute; top: 0px;">Gangster's sushi</a>
                  <a href="https://yandex.ru/maps/67/tomsk/category/food_and_lunch_delivery/184108273/?utm_medium=mapframe&utm_source=maps" style="color: #eee; font-size: 12px; position: absolute; top: 14px;">Доставка еды и обедов в Томске</a>
                  <iframe src="https://yandex.ru/map-widget/v1/?ll=84.986330%2C56.513423&mode=search&oid=82888444717&ol=biz&z=16.61" width="100%" height="400" frameborder="0" allowfullscreen="true" style="position: relative"></iframe>
                </div>
                <form ref="noDelivery" class="mb-4">
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" v-model="noDelForm.name" />
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-group">
                        <label for="tel">Телефон</label>
                        <input type="text" name="tel" id="tel" class="form-control" v-model="noDelForm.tel" v-maska data-maska="+7 (###) ###-##-##" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="personQty" id="personQty" class="form-control text-center fw-bold" v-model="noDelForm.personQty" min="1" max="10" />
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        <label for="comment">Комментарий</label>
                        <textarea name="comment" id="comment" class="form-control" v-model="noDelForm.comment"></textarea>
                      </div>
                    </div>
                  </div>
                </form>
