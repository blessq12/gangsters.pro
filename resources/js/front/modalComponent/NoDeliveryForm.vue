        ...
        "noDelForm.tel"(newVal) {
            if (newVal && typeof newVal === "string") {
                ...
                if (newVal.startsWith("+7 (7") || newVal.startsWith("+7 (8")) {
                    ...
                    this.noDelForm.tel = newVal.replace(/^\+7 \(([78])/, "+7 (");
                }
            }
        },
    },
...
<template>
    <form ref="noDelivery" class="space-y-6 p-4">
...
<style>
/* Удаляем старые стили, так как теперь используем Tailwind */
</style>
