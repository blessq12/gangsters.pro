    ...
    >
        <div class="flex flex-col gap-4">
            ...
            <div
                ...
                class="rounded-2xl bg-[rgba(255,255,255,0.03)] px-5 py-6 text-sm text-slate-300"
            >
            ...
            >
                <li
                    ...
                    :key="item.productId"
                    class="flex items-center justify-between gap-4 rounded-2xl bg-[rgba(255,255,255,0.03)] px-4 py-3"
                >
                    <div class="min-w-0">
