...
use App\Infrastructure\OrderAccountingExport\Adapter\IikoAccountingSystemAdapter;
...
final class OrderAccountingExportServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(IikoApiClient::class);
        ...
        $this->app->singleton(AccountingAdapterRegistry::class, function ($app): AccountingAdapterRegistry {
            return new AccountingAdapterRegistry([
                ...
                $app->make(IikoAccountingSystemAdapter::class),
            ]);
        });
        ...
        $this->app->tag([
            ...
            IikoAccountingSystemAdapter::class,
