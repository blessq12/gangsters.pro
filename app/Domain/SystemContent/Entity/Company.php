...
final class Company
{
    ...
    public function addressComment(): ?string { return $this->addressComment; }
    public function cityCoverage(): ?string { return $this->cityCoverage; }
    public function phone(): ?string { return $this->phone; }
    public function phoneAdditional(): ?string { return $this->phoneAdditional; }
    public function supportPhone(): ?string { return $this->supportPhone; }
    public function whatsappPhone(): ?string { return $this->whatsappPhone; }
    public function emailAddress(): ?string { return $this->emailAddress; }
    public function publicEmail(): ?string { return $this->publicEmail; }
    public function workHours(): ?string { return $this->workHours; }
    public function deliveryHours(): ?string { return $this->deliveryHours; }
    /** @return array<int, array<string, mixed>>|null */
    public function workSchedule(): ?array { return $this->workSchedule; }
    public function minOrderAmountKopecks(): ?int { return $this->minOrderAmountKopecks; }
    public function deliveryFeeKopecks(): ?int { return $this->deliveryFeeKopecks; }
    public function averageDeliveryTimeMinutes(): ?int { return $this->averageDeliveryTimeMinutes; }
    public function telegram(): ?string { return $this->telegram; }
    public function siteUrl(): ?string { return $this->siteUrl; }
    /** @return array<int, array<string, mixed>>|null */
    public function socialLinks(): ?array { return $this->socialLinks; }
    public function vk(): ?string { return $this->vk; }
    public function inst(): ?string { return $this->inst; }
}
