...
use App\Infrastructure\Crm\Port\CrmCatalogAdapter;
use App\Infrastructure\Crm\Port\CrmClientOrdersAdapter;
...
final class CrmServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(CrmClientOrdersPort::class, CrmClientOrdersAdapter::class);
        $this->app->bind(CrmCatalogAvailabilityPort::class, CrmCatalogAdapter::class);
        $this->app->bind(CrmCatalogSnapshotsPort::class, CrmCatalogAdapter::class);
    }
}
